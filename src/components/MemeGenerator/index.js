...
class MemeGenerator extends Component {
  ...
  renderMemeGeneratorForm = () => {
    ...
    return (
      <MemeGeneratorFrom onSubmit={this.onGenerateMeme}>
        ...
        <CustomInput
          ...
          placeholder="Enter tho Top Text"
        />
        ...
        <GenerateButtonn type="submit">Generate</GenerateButtonn>
      </MemeGeneratorFrom>
    )
  }
  ...
  renderMeme = () => {
    ...
    return (
      <MemeContainer data-testis="meme" backgroundImage={backgroundImageUrl}>
